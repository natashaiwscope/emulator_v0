...
static const char qt_meta_stringdata_Console[] = {
    "Console\0\0onCommand(QString)\0"
    "onChange(QString)\0pollSerial()\0"
    "onActionCommand(QString)\0consoleInpSlot()\0"
    "dTimerExpired()\0"
};
...
void Console::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->pollSerial(); break;
        case 3: _t->onActionCommand((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 4: _t->consoleInpSlot(); break;
        case 5: _t->dTimerExpired(); break;
        default: ;
        }
    }
}
